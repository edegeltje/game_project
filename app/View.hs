...
level2GameState = 
  MkGameState
    Playing level2Maze 1 2 level2Entities InputNeutral 0 (MkSettings 1 10) $
      hydrateRngStuff $ initialiseRngState $ MkRngConst magicNumber 0

calcGameStateLevel2 :: Float -> GameState
calcGameStateLevel2 t = MkGameState
    Playing level2Maze 1 2 level2Entities InputNeutral t (MkSettings 1 10) $
      hydrateRngStuff $ initialiseRngState $ MkRngConst magicNumber 0
...
testGameState' = 
  MkGameState
    Playing level3Maze 1 2 testEntities InputNeutral 0 (MkSettings 1 1) $ 
      hydrateRngStuff $ initialiseRngState $ MkRngConst magicNumber 0
